...
public class MenuView : MonoBehaviour, IMenuView
{
    ...
    private void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.Z)) OnConfirm?.Invoke();
    }
    ...
    public void UpdateMenuText(string text) => buttonText.text = text;
    public void UpdateDescriptionText(string text) => descriptionText.text = text;
