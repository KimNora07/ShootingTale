...
public static class AnimationUtility
{
    ...
    /// 슬라이드 애니메이션
    /// </summary>
    /// <param name="runner">MonoBehavior</param>
    ...
    public static void SlideAnimation(MonoBehaviour runner, Image image, float duration, float delay, float start, float end, int fillOrigin, Action onPlay, Action onComplete)
    {
    ...
    private static IEnumerator ImageSlide(Image image, float duration, float delay, float start, float end, int fillOrigin, Action onPlay, Action onComplete)
    {
